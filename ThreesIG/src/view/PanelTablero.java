...
public class PanelTablero extends JPanel {
	...
	/**
	 * Permite mostrar una ficha en una posición determinada.
	 */
	...
	/**
	 * Elimina la ficha de una posición.
	 */
	...
	/**
	 * Crea visualmente una ficha según su valor.
	 */
	...
	/**
	 * Determina el tamaño de fuente según la cantidad de dígitos.
	 */
	...
	/**
	 * Define el color visual de cada tipo de ficha.
	 */
	private Color obtenerColor(int valor) {

		Map<Integer, Color> colores = new HashMap<>();
